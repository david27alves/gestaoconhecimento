                    ...
                    <h6 class="card-subtitle mb-2 text-muted">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <p class="mt-0">David Alves</br>em <a href="categoria/{{ $conhecimento[0]->categoria->id }}" style="text-decoration: none; color: #6c757d">{{ $conhecimento[0]->categoria->descricao }}</a></p>
